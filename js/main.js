...
const levelData = {
  inicial: {
    ...
    description:
      "En nuestro nivel inicial, nos enfocamos en el desarrollo integral del niño a través del juego y la exploración. Nuestro método estimula la creatividad, la socialización y el desarrollo emocional en un ambiente seguro y acogedor.",
    features: [
  ...
  primaria: {
    ...
    description:
      "Formamos una base sólida de conocimientos y valores. Fomentamos el pensamiento crítico, la investigación y el trabajo en equipo, preparando a los estudiantes para los retos académicos del futuro.",
    features: [
  ...
  secundaria: {
    ...
    description:
      "Potenciamos las habilidades académicas y personales de nuestros estudiantes. Nuestro sistema pre-universitario desde los últimos años garantiza un alto nivel de competitividad y éxito en admisiones universitarias.",
    features: [
  ...
  academia: {
    ...
    description:
      "Somos especialistas en el ingreso a la Universidad Nacional de Piura (UNP) y otras universidades de prestigio. Nuestro sistema intensivo y plana docente experta maximizan tus posibilidades de ingreso.",
    features: [
  ...
  ceba: {
    ...
    description:
      "Nunca es tarde para terminar tus estudios. Nuestro programa CEBA permite concluir la primaria o secundaria en corto tiempo con horarios flexibles adaptados a personas que trabajan.",
    features: [
